...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'dive/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dive/static'),
]
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'dive.api.utils.custom_exception_handler'
}
