...
urlpatterns = [
    ...
    path("templates/<str:account_id>", views.get_account_templates, name="get_account_templates"),
    path("templates/<str:app>/<str:account_id>", views.get_obj_templates, name="get_obj_templates"),
