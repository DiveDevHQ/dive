...
export default function SchemaEditor({ item }) {
    ...
    function saveChunkingType(templateId) {
        ...
        if (chukingType==='custom'){
            chunkingTypeObj.chunk_size = chunkSize?chunkSize:1024;
    ...
    return (
        <div>
            ...
            <div className='row'>
                ...
                <div className='col-3'>
                    {(chukingType === 'custom') && (<>Chunk size: <input className='form-control-short' value={chunkSize || "1024"} onChange={e => setChunkSize(e.target.value)}
                        type="text" /></>)}
                </div>
                <div className='col-3'>
